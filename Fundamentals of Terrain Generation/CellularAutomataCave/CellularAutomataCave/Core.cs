...
namespace CellularAutomataCave
{
    public class Core : Game
    {
        ...
        private CellularAutomataCave _cellularAutomataCave;

        private readonly float _stepTime = 0.5f;
        ...
        protected override void Initialize ()
        {
            ...
            _cellularAutomataCave = new CellularAutomataCave (size: 128, iteration: 8, aliveRate: 0.35f);
        }
        ...
        protected override void Draw (GameTime gameTime)
        {
            ...
            _cellularAutomataCave.Draw (SpriteBatch);
            SpriteBatch.End ();
